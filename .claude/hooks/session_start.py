...
def format_welcome_message(source: str, context: Dict[str, Any]) -> str:
    ...
    # Base message by source type
    if source == "startup":
        base_msg = f"Session started for {project_name}"
    elif source == "resume":
        base_msg = f"Resuming work on {project_name}"
    elif source == "clear":
        base_msg = f"New session initialized for {project_name}"
    else:
        base_msg = f"Session active for {project_name}"
...
def generate_context_injection(context: Dict[str, Any]) -> str:
    ...
    # Project overview
    parts.append("# Multi-Agent Observability System - Session Context")
    parts.append("")
...
def create_hook_event(session_id: str, source: str, context: Dict[str, Any]) -> Dict[str, Any]:
...
def main():
    ...
    try:
        ...
        event = create_hook_event(session_id, source, context)
